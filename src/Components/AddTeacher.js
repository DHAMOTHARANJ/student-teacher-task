...
//// after adding input box will get empty
  ...
  return (
    ...
    <div className='form-grp'>
      ...
      <input placeholder='Enter the Mentor Name' type='text'
      value={name}
      onChange={(e)=>setName(e.target.value)}/>
      <input placeholder='Enter Batch name'
      value={batch}
      onChange={(e)=>setBatch(e.target.value)}/>
      <input placeholder='Enter Qualification' type='text'
      value={education}
      onChange={(e)=>setEducation(e.target.value)}/>
      <input placeholder='Enter past Experience in years' type='text'
      value={experience}
